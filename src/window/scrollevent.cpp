...
#include <fmr/window/scrollevent.h>
#include <wx/window.h>
...
ScrollWinEvent::ScrollWinEvent(wxEventType type, int position,
                               wxOrientation orient, wxWindow *win) {
  SetEventType(type);
  SetEventObject(win);
...
void ScrollWinEvent::SetPosition(int pos) { m_position = pos; }

void ScrollWinEvent::SetOrientation(wxOrientation orient) {
  m_orientation = orient;
}

int ScrollWinEvent::GetPosition() const { return m_position; }

wxOrientation ScrollWinEvent::GetOrientation() const { return m_orientation; }
