    ...
    : public AbstractOpenableHandler
{
    public:
        ...
        bool CreateFiles( SStream stream, const std::string &filename, bool overwite = false );
    ...
    private:
        ...
        void OpenStream( const std::string &filename, SStream &stream, bool is_get_stream );
