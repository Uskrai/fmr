 ...
 * @return false
 */
bool Rescale(wxImage &image, float scale,
 ...
 */
bool Rescale(SBitmap &bmp, wxImage &original_image, float scale,
             wxImageResizeQuality image_qualitry = wxIMAGE_QUALITY_NORMAL);
