...
class StreamBitmapEvent : public wxCommandEvent {
 public:
  ...
  void SetStreamBitmap(const StreamBitmap &item) { stream_bitmap_ = item; }
...
#define StreamBitmapEventHandler(func) \
  wxEVENT_HANDLER_CAST(StreamBitmapEventFunction, func)
